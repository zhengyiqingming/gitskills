	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
				document.getElementById("captchaImage").src="${pageContext.request.contextPath}/admin/createImg.do?xx="+Math.random();
			});
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath }/admin/createImg.do" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
